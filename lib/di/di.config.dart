...
import '../features/arm/data/i_repository.dart' as _i15;
import '../features/arm/data/repository/arm_repository_impl.dart' as _i16;
import '../features/arm/presenter/bloc/load_arms_bloc.dart' as _i17;
...
import '../features/auth/presentation/cubit/auth_cubit.dart' as _i12;
...
import '../features/main/bloc/bloc/main_bloc.dart' as _i18;
import '../features/main/repository/i_repo_main.dart' as _i13;
import '../features/main/repository/repo_main.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i12.AuthCubit>(() => _i12.AuthCubit(gh<_i3.IAuthData>()));
    gh.singleton<_i13.IRepoMain>(
        () => _i14.RepoMain(gh<_i11.SharedPreferences>()));
    gh.singleton<_i15.IRepository>(() => _i16.ArmRepositoryImpl(
    ...
    gh.factory<_i17.LoadArmsBloc>(
        () => _i17.LoadArmsBloc(gh<_i15.IRepository>()));
    gh.factory<_i18.MainBloc>(() => _i18.MainBloc(gh<_i13.IRepoMain>()));
    return this;
  }
}

class _$RegistryModule extends _i19.RegistryModule {}
